...
SRCS = main.c signal.c utils.c utils1.c parsing_input.c parsing_utils.c\
	   ...
	   action_scanner_list_utils.c configure_streams_utils.c utils2.c initialize_shell_inf.c\
